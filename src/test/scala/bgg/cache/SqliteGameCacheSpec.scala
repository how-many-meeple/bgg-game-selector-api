...
class SqliteGameCacheSpec extends AnyWordSpec with Matchers with BeforeAndAfterEach:
  ...
  private def testGame(id: Int = 1, name: String = "Test Game"): GameData =
    GameData(
      ...
      minPlayers = Some(2), maxPlayers = Some(4),
      minPlayingTime = Some(30), maxPlayingTime = Some(60), playingTime = Some(60),
      ratingAverage = Some(7.5), ratingAverageWeight = Some(2.5),
